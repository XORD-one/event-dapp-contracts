...
interface PolkalokrTokenInterface extends ethers.utils.Interface {
  functions: {
    "BLACKLISTED_ROLE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "BLACKLISTED_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class PolkalokrToken extends Contract {
  ...
  interface: PolkalokrTokenInterface;

  functions: {
    BLACKLISTED_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    BLACKLISTED_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    BLACKLISTED_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
